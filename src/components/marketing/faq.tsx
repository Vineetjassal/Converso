...
const faqs = [
  {
    question: "Why should I use Converso instead of Google Forms?",
    answer:
      "Because you deserve better than a spreadsheet in disguise. Converso lets you create forms that feel like a conversation, not a pop quiz from your least favorite teacher.",
  },
  {
    question: "Is Converso really AI-powered, or is it just a fancy buzzword?",
    answer:
  ...
  {
    question: "Is Converso actually free?",
  ...
  {
    question: "Can I use Converso if I have zero tech skills?",
    answer:
      "If you can order pizza online, you’re overqualified for Converso. No coding, no tech bro nonsense, and no judgment if you still use Internet Explorer (well, maybe a little).",
  },
];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-4 max-w-2xl mx-auto">
            Everything you need to know about Converso&apos;s AI-native
