export function getFormGenPrompt({
  ...
  return `
    # Platform Context
    Converso is an AI-native form building platform that creates conversational forms. Unlike traditional forms with rigid input fields, Converso creates a natural, chat-based interface where respondents can simply answer questions conversationally.
